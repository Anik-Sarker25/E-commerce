        ...
        <div class="menu-item dropdown dropdown-mobile-full">
            <a href="#" data-bs-toggle="dropdown" data-bs-display="static" class="menu-link">
                <div class="menu-img online">
                    <img src="{{ asset('backend/assets/img/user/profile.jpg') }}" alt="Profile" height="60">
                </div>
            ...
            <div class="dropdown-menu dropdown-menu-end me-lg-3 fs-11px mt-1">
                ...
                <a class="dropdown-item d-flex align-items-center" href="javascript:;"  onclick="event.preventDefault(); document.getElementById('adminLogoutForm').submit();">LOGOUT <i class="bi bi-toggle-off ms-auto text-theme fs-16px my-n1"></i></a>
